...
English is a natural translation. Dish names stay in Spanish on purpose:
they are the brand's own vocabulary and what people actually search for.

Prices are USD, exactly as printed. If the restaurant changes a price, this
file is the only place it needs to change.
"""
...
ALMUERZO = [
 {
  ...
  "photos": [("tacos-dorados", "Tacos Dorados"), ("esquite-y-nachos-hermanos", "Nachos Hermanos"),
             ("pizza-jalapena", "Pizza Jalapeña")],
  "items": [
   ...
   {"n":"Pizza Jalapeña","p":"9.95",
    ...
    "hint_es":"Sí, le podés quitar el jalapeño.","hint_en":"Yes, you can ask for it without the jalapeño."},
  ...
  ]},
 {
  "id": "tacos",
  "es": "Tacos", "en": "Tacos",
  "note_es": "Nuestros tacos los servimos de 4 en 4. Los podés combinar de 2 en 2. Cada taco tiene su personalidad, todos nos hacen sentir orgullosos.",
  ...
  "photos": [("tacos-clasicos", "Los clásicos"), ("quesabirrias", "Quesabirrias"),
             ("tacos-banados", "Tacos Bañados")],
  "items": [
   {"n":"Asada","p":"6.95",
   ...
   {"n":"Fundidos","p":"7.95",
    ...
    "hint_es":"Podés combinarlos de 2 en 2.","hint_en":"You can mix them two and two."},
  ...
  ]},
 {
  ...
  "note_es": "Hechos con estilo y logrados con pasión.",
  "note_en": "Made with style and achieved with passion.",
  "photos": [("burros", "Burros"), ("torta-derretida", "Torta Derretida"),
             ("gringas-y-el-machete", "El Machete")],
  "items": [
   {"n":"Burros","p":"7.50",
    ...
    "hint_es":"Agregá costra de queso por $1.00.","hint_en":"Add a cheese crust for $1.00."},
  ...
  ]},
 {
  ...
  "note_es": "", "note_en": "",
  "photos": [("bowl-hermano", "Bowl Hermano"), ("sombreritos", "Sombreritos")],
  "items": [
   {"n":"Bowl Hermano","p":"9.95",
    "es":"¡El más esperado! Arroz cilantro y limón, maíz dulce, frijoles, pico de gallo, aguacate, queso rallado, tortilla crocante y cilantro. Servido con nuestra espectacular salsa verde.",
   ...
   {"n":"Sombrerito de Pollo Chipotle","p":"",
...
# =========================================================================
# DESAYUNOS  (breakfast menu, July 2026)
# =========================================================================
...
DESAYUNOS = [
 ...
 {"n":"Tostada de Aguacate","p":"7.95",
  ...
  "hint_es":"Podés pedirla con claras de huevo.","hint_en":"You can order it with egg whites."},
...
DESAYUNO_ESPECIALES = [("Batido de Café","Coffee Shake","3.50"),("Cebada de Fresa","Strawberry Cebada","2.95"),
  ("Cremoso de Banano","Banana Cremoso","3.50"),("Cremoso de Maní","Peanut Cremoso","3.50"),
  ("Cremoso de Chocolate","Chocolate Cremoso","3.50")]
